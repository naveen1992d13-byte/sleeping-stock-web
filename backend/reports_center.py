...
def _rows(report, inventory, orders, order_items, reqs):
    if report=="inventory":
        ...
        for i in order_items:
            o=om.get(i.get("order_id"),{}); rq=_num(i.get("required_qty")); av=_num(i.get("available_qty",i.get("allocated_qty"))); unit=_num(i.get("value"), _num(i.get("unit_value"))); total=_num(i.get("total_value"), rq*unit); alloc=i.get("allocations") or []
            data.append([o.get("order_number",i.get("order_number")),o.get("created_at"),o.get("created_user_name",o.get("created_by")),o.get("brand_name"),o.get("dealer_name"),o.get("branch"),i.get("part_number"),i.get("description"),rq,av,max(0,rq-av),_text(i.get("suggested_branch"),alloc[0].get("branch") if alloc else ""),_num(i.get("reserved_qty",i.get("allocated_qty"))),i.get("purchase_aging_days",i.get("purchase_aging")),i.get("sales_aging_days",i.get("sales_aging")),_text(i.get("loc"),i.get("location")),unit,total,i.get("status"),i.get("request_number")])
