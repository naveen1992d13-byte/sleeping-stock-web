...
export function DashboardLayout() {
  ...
  const navItems = [
    ...
    { path: '/products', label: 'Product Hub', icon: Package, id: 'products', adminOnly: false },
    { path: '/product-history', label: 'Product Hub History', icon: FileSpreadsheet, id: 'product-history', adminOnly: true },
    { path: '/orders', label: 'Order Desk', icon: ClipboardCheck, id: 'orders', adminOnly: false },
    { path: '/requests', label: 'Request Center', icon: ClipboardList, id: 'requests', adminOnly: false },
    ...
    { path: '/', label: 'Notice Board', icon: Megaphone, id: 'dashboard', adminOnly: false },
    { path: '/query', label: 'Query Desk', icon: HelpCircle, id: 'query', adminOnly: false },
  ];

  const filteredNavItems = navItems.filter((item) => canAccessPermission(user, item.label));
